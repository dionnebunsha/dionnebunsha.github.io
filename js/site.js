...
const ARTICLES = [
  ...
  { slug: "trade-a-free-for-all", title: "Trade: A Free for all?", date: "2007-02-23", categories: ["Farm Crisis"], description: "While farmers in developed countries, constituting less than three per cent of the population, enjoy huge subsidies, India actually taxes its farmers. With substantive cuts in subsidies for power a...", image: "images/1998-07-01 Bitter Harvest 1.jpg", featured: false },
  ...
  { slug: "digging-up-the-dead", title: "Digging up the Dead", date: "2006-11-19", categories: ["Gujarat Violence"], description: "Looking for a dead relative? Get your shovel. Uncover a mass grave. You may expose the cops' cover-up —but you will be arrested.", image: "images/2006-01-14 - digging up site.jpg", featured: false },
  ...
  { slug: "let-the-worms-out", title: "Let the worms out", date: "2006-11-18", categories: ["Gujarat Violence"], description: "The Supreme Court directive to review more than 2,000 “true but undetected” cases in Gujarat is bound to expose police complicity.", image: "images/2003-03-01 G%2B1 - MERGED photo 1.jpg", featured: false },
  { slug: "pirana-in-chains", title: "Pirana in chains", date: "2006-11-18", categories: ["Gujarat Violence"], description: "A Gujarat village that follows a Sufi-inspired faith, a blend of Islam and Hinduism, is in danger of being swamped by Hindu fundamentalism.", image: "images/2004-08-28 pirana.jpg", featured: false },
  ...
  { slug: "love-in-the-time-of-hate", title: "Love in the time of hate", date: "2006-11-18", categories: ["Gujarat Violence"], description: "If a Hindu girl dares choose a groom outside the religion, she risks being kidnapped by the Bajrang Dal.", image: "images/2004-04-10 UK funding of hate photo 2.jpg", featured: false },
  { slug: "corpses-haunt-the-cops", title: "Corpses haunt the cops", date: "2006-11-18", categories: ["Gujarat Violence"], description: "Bilkis  was gang raped and left for dead. The police buried the evidence and shut the case. But the bodies  of the 14 others who died in the attack  were exhumed, exposing the police complicity in ...", image: "images/2006-01-14 - digging up ameena.jpg", featured: false },
  { slug: "justice-available-outside", title: "Justice: available outside", date: "2006-11-18", categories: ["Gujarat Violence"], description: "The blatant human rights abuses in Gujarat has prompted the National Human Rights Commission to petition the Supreme Court to move the cases outside the state.", image: "images/2003-03-01 G%2B1 - MERGED photo 3.jpg", featured: false },
  { slug: "pols-apart", title: "Pols apart", date: "2006-11-18", categories: ["Gujarat Violence"], description: "In Ahmedabad, a patchwork of ghettos, even real estate is dictated by religion.", image: "images/2002-03-16 Guj 1 rural violence pic 4.jpg", featured: false },
  ...
  { slug: "the-midnight-knock", title: "The Midnight Knock", date: "2006-11-18", categories: ["Gujarat Violence"], description: "BJP leader Haren Pandya has been assassinated. It's the ISI. Let's raid the Muslim bastis.", image: "images/2003-05-10 ISI agents photo 1.jpg", featured: false },
  ...
  { slug: "voting-to-stay-alive", title: "Voting to stay alive", date: "2006-11-17", categories: ["Gujarat Violence"], description: "The refugees of Gujarat woke up early. They huddled into trucks. And went back home: to vote.", image: "images/2002-12-21 Election - main photo 1.jpg", featured: false },
  { slug: "the-only-safe-bearded-man-in-gujarat", title: "The only safe bearded man in Gujarat", date: "2006-11-17", categories: ["Gujarat Violence"], description: "A profile of Gujarat chief minister Narendra Modi", image: "images/modi at godhra 1.jpg", featured: false },
  { slug: "heil-hindutva", title: "Heil Hindutva!", date: "2006-11-17", categories: ["Gujarat Violence"], description: "After dividing the state, it's time to rule. Narendra Modi and his men are swept in on a post-Godhra vote.", image: "images/2002-12-21 Election - main photo 2.jpg", featured: false },
  { slug: "their-only-voice-is-their-vote", title: "Their only voice is their vote", date: "2006-11-17", categories: ["Gujarat Violence"], description: "The Muslims may have been broken and silenced. But they still have the most powerful democratic weapon—the vote. And they are determined to wield it.", image: "images/2002-12-07 Guj pre-poll photo 1.jpg", featured: false },
  ...
  { slug: "after-the-bullets-the-ballot", title: "After the bullets, the ballot", date: "2006-10-31", categories: ["Gujarat Violence"], description: "Chief Minister Narendra Modi is a man in a hurry—to cash in on the hate at the hustings. Will it pay?", image: "images/2002-10-12 Akshardham_Report 2.jpg", featured: false },
  { slug: "the-gujarati-press-rumour-or-news", title: "The Gujarati press: Rumour or news?", date: "2006-10-31", categories: ["Gujarat Violence"], description: "The regional press had no small role in fanning the flames. Goebbels in Gujarat?", image: "images/2003-03-01 G%2B1 - MERGED photo 8.jpg", featured: false },
  { slug: "chariots-of-fear", title: "Chariots of Fear", date: "2006-10-31", categories: ["Gujarat Violence"], description: "The Jagannath rath yatra passes without incident, but for Gujarat's Muslims it is life on the edge, for the fifth month running.", image: "images/2003-03-01 G%2B1 - MERGED photo 9.jpg", featured: false },
  ...
  { slug: "go-home-gujarat-is-back-to-normal", title: "Go home. Gujarat is back to normal", date: "2006-10-31", categories: ["Gujarat Violence"], description: "The government wants the camps closed. Chased away, refugees are even living under trees.", image: "images/2002-04-27 camp in field.jpg", featured: false },
  { slug: "back-to-abnormal", title: "Back to Abnormal", date: "2006-10-31", categories: ["Gujarat Violence"], description: "It's a long road back home when there's no home to go back to. With the monsoon approaching, people may be stranded in relief camps for longer than they imagined.", image: "images/2002-03-16 guj 1 relief camp.0.jpg", featured: false },
  { slug: "refugees-bounce-back-the-cheques", title: "Refugees bounce back the cheques", date: "2006-10-31", categories: ["Gujarat Violence"], description: "Disgusted by the pittance being handed out, riot victims reject the government's token compensation.", image: "images/2002-03-16 guj 1 relief camp pic.0.jpg", featured: false },
  { slug: "more-hate-more-votes", title: "More hate, more votes", date: "2006-10-31", categories: ["Gujarat Violence"], description: "Keep the Godhra Ghost alive. Keep the hate going till the elections.", image: "images/2003-03-01 G%2B1 - MERGED photo 10.jpg", featured: false },
  { slug: "free-and-unfair-elections-in-the-wild-west", title: "Free and Unfair Elections in the Wild West", date: "2006-10-31", categories: ["Gujarat Violence"], description: "Even as the attacks on the minorities continue relentlessly, the BJP government's priority in Gujarat appears to be holding Assembly elections rather than providing relief and rehabilitation.", image: "images/2003-03-01 G%2B1 - MERGED photo 11.jpg", featured: false },
  { slug: "give-violence-a-chance", title: "Give violence a chance", date: "2006-10-31", categories: ["Gujarat Violence"], description: "The government shows no desire to put out the fires. In fact, it even appears that it wants to keep the flames burning.", image: "images/2002-03-16 Guj 1 rural violence pic 10001.jpg", featured: false },
  { slug: "clean-out-the-camps", title: "Clean out the camps", date: "2006-10-31", categories: ["Gujarat Violence"], description: "With the PM visiting, government officials have suddenly appeared in relief camps. They want to clean them up…and clear them out.", image: "images/2002-05-25 malnutrition pic 1.jpg", featured: false },
  { slug: "the-apostles-of-violence", title: "The apostles of violence", date: "2006-10-31", categories: ["Gujarat Violence"], description: "The violence continues in Gujarat abetted by the state. The mobs rule.", image: "images/2003-06-07 vhp camp.jpg", featured: false },
  ...
  { slug: "crocodiles-day-out", title: "Crocodile's day out", date: "2006-10-24", categories: ["Environment"], description: "Central Gujarat went under. Was it a freak downpour or did Baroda sink under the weight of its own development?", image: "images/baroda flood pic 1 by AFP.jpg", featured: false },
  ...
  { slug: "dandi-in-the-time-of-globalisation", title: "Dandi in the time of globalisation", date: "2006-10-22", categories: ["Globalization"], description: "Gandhiji's march to Dandi was the beginning of the end for the British. The 75th anniversary march was a bizarre political pilgrimage with a motley mix of foreigners, Pakistanis, old Gandhians and ...", image: "images/dandi photo 1.jpg", featured: false },
  { slug: "private-water-public-thirst", title: "Private water, public thirst", date: "2006-10-22", categories: ["Globalization"], description: "Maharashtra's first experiment in privatisation of drinking water supply has left Chandrapur high and dry", image: "images/chandrapur water privatisation photo 1.jpg", featured: false },
  ...
  { slug: "bulldozing-bombays-belly", title: "Bulldozing Bombay's Belly", date: "2006-10-22", categories: ["Mumbai"], description: "It's a Rs 1,600 crore street economy that employs 200,000 people. Why is the municipality bent on uprooting Mumbai's hawkers?", image: "images/mumbai hawkers 1.jpg", featured: false },
  ...
  { slug: "zaheera-interview", title: "'I want the case to be reopened' : Zaheera", date: "2006-10-22", categories: ["People"], description: "'I want the case to be reopened' : Zaheera", image: "images/zaheera interview.jpg", featured: false },
